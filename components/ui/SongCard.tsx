...
import { Play, Heart, Pause, ListPlus } from "lucide-react";
      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            className="absolute bottom-2 left-2 z-20 w-7 h-7 rounded-full flex items-center justify-center backdrop-blur-sm hover:text-purple-300"
            style={{
        ...
        <div className="space-y-0.5 px-0.5">
          ...
          <div className="flex items-center justify-between gap-2">
            <Link
              ...
              className="text-[11px] truncate leading-tight hover:text-purple-300 transition-colors block w-fit"
